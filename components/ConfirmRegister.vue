    ...
    <div class="order-success-wrapper">
      <div class="custom-container">
        <div class="order-done-content">
          ...
          <p>Por favor revisa la bandeja de entrada de tu correo electrónico para activar tu cuenta. Si no recibiste el correo electrónico, no dudes en contactarnos. Gracias!</p>
