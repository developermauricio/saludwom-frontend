    ...
    <div class="order-success-wrapper">
      <div class="custom-container">
        <div class="order-done-content">
          ...
          <h5>¡Envío Exitoso!</h5>
          <p>Por favor revisa la bandeja de entrada de tu correo electrónico para restablecer tu contraseña. Si no recibiste el correo electrónico, no dudes en contactarnos. Gracias!</p>
...
<script>
export default {
  name: "ConfirmResetPasswordEmail"
}
</script>
