...
const routes = [
    ...
    =============================================*/
  {
    ...
    children: [
      ...
      {
        path: '/webapp/valoracion/crear',
        name: 'valuation.create',
        component: page('webapp/valuations/create/CreateValuation.vue')
      },
      ...
      /* Rutas para las suscripciones*/
      {
        ...
        component: page('webapp/subscriptions/IndexSubscriptions.vue')
      },
      /* Rutas para el historial de pagos*/
      {
        path: '/webapp/perfil/historial-pagos',
  ...
  {
    path: '/api/v1/verification/verify/:id',
